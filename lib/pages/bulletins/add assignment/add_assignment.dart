                        ...
                        children: [
                          ...
                          if (assignmentController.assignmentType.value ==
                            ...
                            CustomDropdownField(
                                ...
                                if (assignmentController.isStandardAssignment ==
                                  ...
                                  for (int i = 0;
                                    ...
                                    if (assignmentController.dept[i]["id"]
                                      ...
                                      assignmentController.selectedAssignees
                                          .add(assignmentController.dept[i]
                                              ["name"]);
                                      assignmentController.assignment.deptid =
                              ...
                              mitems: assignmentController.dept
                                  .map((dynamic option) {
                                ...
                                return DropdownMenuItem<String>(
                                  ...
                                  child:
                                      Text(assignmentController.truncatedName),
                                );
                              }).toList(),
                            ),
                          if (assignmentController.assignmentType.value ==
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: UnconstrainedBox(child: navigateToWidget()),
                      ),
                      Flexible(
                        child: Container(
